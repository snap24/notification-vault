...
public interface NotificationDao {
    ...
    @Query("UPDATE notifications SET text = :text, timestamp = :timestamp, imagePath = :imagePath, duplicateCount = :count, isRead = 0 WHERE id = :id")
    void updatePhotoSession(long id, String text, long timestamp, String imagePath, int count);
}
